...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-5 js-redirect">
            <div class="home-topic">
                <?php if( have_rows('topic1') ):
                while( have_rows('topic1') ): the_row(); ?>
                    <div class="home-topic__img js-home-topic--left" data-max="<?php echo count(get_sub_field('topic1_imgs')); ?>" <?php echo $imgs; ?>>
        ...
        <div class="col-5 offset-2 js-redirect">
